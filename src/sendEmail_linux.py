...
sys.path.append('/media/SSD2/cloud_data/Projects/CACSFilter/src')

#from YAML import YAML

f = open('/media/SSD2/cloud_data/Projects/CACSFilter/src/tmp.txt' ,"w")
f.write("Starting")
f.close()
...
def initYMLFile(filepath_yaml):
    if is_windows:
        ...
        folderpath_templates = '/media/SSD2/cloud_data/Projects/CACSFilter/src/email/templates'
    ...
    ProblemSummaryEmail = {'Date of the ICA images are wrong': 'DateICA_template.txt',
                           ...
                           'ICA problem': 'MissingICA_template.txt',
                           'Problem with images': 'MissingICA_template.txt'}
...
def replaceEmail(filepath_template, filepath_email, problemList, settings):
    ...
    try:
        ...
        print("------------ Error ------------")
        print('filepath_template', filepath_template)
        print('Replacing PROBLEMLIST', PATIENTIDLIST)
        print('Replacing PATIENTIDLIST', PATIENTIDLIST)
        print('Replacing PATIENTID', PATIENTID)
        print('Replacing PROBLEM', PROBLEM)
